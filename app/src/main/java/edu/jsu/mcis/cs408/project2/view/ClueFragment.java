...
public class ClueFragment extends Fragment implements TabFragment, AbstractView {
    ...
    public void modelPropertyChange(final PropertyChangeEvent evt) {
        ...
        if (propertyName.equals(DefaultController.CLUES_ACROSS_PROPERTY)) {
            binding.acrossList.setText(evt.getNewValue().toString());
            binding.acrossList.setMovementMethod(new ScrollingMovementMethod());
        }
        else if (propertyName.equals(DefaultController.CLUES_DOWN_PROPERTY)) {
            binding.downList.setText(evt.getNewValue().toString());
            binding.downList.setMovementMethod(new ScrollingMovementMethod());
        }
    }
